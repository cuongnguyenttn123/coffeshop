 ...
 */
@Entity
@Table(name = "importbill", catalog = "coffeshop")
public class Importbill implements java.io.Serializable {
	...
	public Importbill(Integer importbillid) {
		this.importbillid = importbillid;
	}

	public Importbill(Integer importbillid, Employee employee, Supplier supplier, Date updateat, Boolean isdelete,
