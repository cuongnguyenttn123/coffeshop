                ...
                <div class="row">
                    <div class="col-10">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="/admin/employee/add" method="post"><input name="__RequestVerificationToken" type="hidden" value="EhnBzwQSBtZ_2TKwtouBh5Arb-_CDDgep_yXZnDrmDgRf16DCzE2TCkZEQRDndykrLWaKsa3ynPou8JRX2r3A9dLINNra87Lf3IxneswF4k1" />                    <div class="form-horizontal">
