                ...
                <div class="row">
                    <div class="col-10">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="/Admin/User/Edit/1" method="post"><input name="__RequestVerificationToken" type="hidden" value="A25r7i7uuN1luutf70MUfnWzs4zVPrI7496xCtiF6pJkTbwyZ6qTouyT6PMXo98PUEjqZhrrc6Qfr4T7cITdfj5h_4L6g0KscBMkStSejQM1" />                    <div class="form-horizontal">
                                    ...
                                    <input data-val="true" data-val-number="The field Quyền must be a number." data-val-required="The Quyền field is required." id="idRole" name="idRole" type="hidden" value="1" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input data-val="true" data-val-length="The field Mật khẩu must be a string with a maximum length of 50." data-val-length-max="50" data-val-required="The Mật khẩu field is required." htmlAttributes="{ class = col-5 }" id="PassWord" name="PassWord" style="border-radius:5px;outline:none;padding:5px" type="text" value="1" />
                                        <span class="field-validation-valid text-danger" data-valmsg-for="PassWord" data-valmsg-replace="true"></span>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-3" for="Name">Họ t&#234;n</label>
                                        <input data-val="true" data-val-length="The field Họ tên must be a string with a maximum length of 50." data-val-length-max="50" data-val-required="The Họ tên field is required." htmlAttributes="{ class = col-5 }" id="Name" name="Name" style="border-radius:5px;outline:none;padding:5px" type="text" value="Nguyễn Văn Cường" />
                                        <span class="field-validation-valid text-danger" data-valmsg-for="Name" data-valmsg-replace="true"></span>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-3" for="Email">Email</label>
                                        <input data-val="true" data-val-length="The field Email must be a string with a maximum length of 100." data-val-length-max="100" data-val-required="The Email field is required." htmlAttributes="{ class = col-5 }" id="Email" name="Email" style="border-radius:5px;outline:none;padding:5px" type="text" value="doquangtaia3@gmail.com" />
                                        <span class="field-validation-valid text-danger" data-valmsg-for="Email" data-valmsg-replace="true"></span>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-3" for="Address">Địa chỉ</label>
                                        <input data-val="true" data-val-length="The field Địa chỉ must be a string with a maximum length of 150." data-val-length-max="150" data-val-required="The Địa chỉ field is required." htmlAttributes="{ class = col-5 }" id="Address" name="Address" style="border-radius:5px;outline:none;padding:5px" type="text" value="BN" />
                                        <span class="field-validation-valid text-danger" data-valmsg-for="Address" data-valmsg-replace="true"></span>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-3" for="Phone">SDT</label>
                                        <input data-val="true" data-val-length="The field SDT must be a string with a maximum length of 50." data-val-length-max="50" data-val-required="The SDT field is required." htmlAttributes="{ class = col-5 }" id="Phone" name="Phone" style="border-radius:5px;outline:none;padding:5px" type="text" value="0377990688" />
