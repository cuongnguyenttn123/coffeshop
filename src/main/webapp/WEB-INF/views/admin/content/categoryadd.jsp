                ...
                <div class="row">
                    <div class="col-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="/admin/category/add" method="post"><input name="__RequestVerificationToken" type="hidden" value="L6t8tGpe0486lfz6sHG-HAEfwwOaEQeKRdu8OxnR_Q-CcKBatQbBqb3QK75Cz4koRBps-kBL3UJwE8KEN8M-a1vvWI1au74xp_cef4jbY1w1" />
                                    <div class="form-horizontal">

                                        <input data-val="true" data-val-number="The field FoodCategory_id must be a number." data-val-required="The FoodCategory_id field is required." id="FoodCategory_id" name="FoodCategory_id" type="hidden" value="" />
